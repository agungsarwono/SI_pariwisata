...
export default function TambahDestinasiPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (res.ok) {
                setShowToast(true)
                // Redirect logic handled by Toast onClose or separate timeout
                setTimeout(() => {
    ...
    return (
        <div className="max-w-4xl mx-auto space-y-6">
            <AnimatePresence>
                {showToast && (
                    <Toast
                        message="Destinasi baru berhasil ditambahkan ke database."
                        type="success"
                        onClose={() => {
                            setShowToast(false)
                            router.push('/destinasi')
            ...
            <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                    <h1 className="text-2xl font-bold text-slate-900 dark:text-white">Tambah Destinasi Baru</h1>
                    <p className="text-slate-500 dark:text-slate-400 text-sm">Isi formulir berikut untuk menambahkan lokasi wisata baru.</p>
                </div>
            </div>
            ...
            >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-2">
                            ...
                            <input
                                ...
                                className="w-full px-4 py-2 rounded-xl border border-slate-200 dark:border-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all placeholder:text-slate-300 dark:bg-slate-800 dark:text-white dark:placeholder-slate-500"
                ...
                <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <textarea
                            ...
                            className="w-full px-4 py-3 rounded-xl border border-slate-200 dark:border-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all placeholder:text-slate-300 resize-none dark:bg-slate-800 dark:text-white dark:placeholder-slate-500"
                ...
                <div className="space-y-4">
                    ...
                    >
                        {imagePreview ? (
                            ...
                            <>
                                ...
                                <p className="font-medium text-slate-600 dark:text-slate-300">Klik untuk upload foto</p>
                    ...
                    {imagePreview && (
                        <button
                            type="button"
                            onClick={(e) => { e.stopPropagation(); setImagePreview(null); setFormData(prev => ({ ...prev, image: "" })); }}
