    ...
    return (
        <div className="max-w-4xl mx-auto space-y-6">
            ...
            <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                    <h1 className="text-2xl font-bold text-slate-900">Tambah Destinasi Baru</h1>
                    <p className="text-slate-500 text-sm">Isi formulir berikut untuk menambahkan lokasi wisata baru.</p>
                </div>
            </div>
                    ...
                    >
                        {imagePreview ? (
                            ...
                            <>
                                ...
                                <p className="font-medium text-slate-600">Klik untuk upload foto</p>
