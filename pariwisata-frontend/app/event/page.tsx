                                ...
                                filteredEvents.map((event) => (
                                    ...
                                    >
                                        ...
                                        <div className="flex items-center md:items-end justify-end gap-2">
                                            ...
                                            <Link
                                                href={`/event/${event.id}`}
                                                className="px-4 py-2 rounded-lg bg-slate-50 text-slate-600 font-medium text-sm hover:bg-blue-50 hover:text-blue-600 transition-colors"
                                            >
                                                Detail
                                            </Link>
                                        </div>
                    ...
                    <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm">
                        ...
                        <div className="grid grid-cols-7 gap-1 text-center text-sm mb-2">
                            {['Min', 'Sen', 'Sel', 'Rab', 'Kam', 'Jum', 'Sab'].map(d => (
                                <div key={d} className="text-slate-400 py-1 text-xs font-semibold">{d}</div>
                            ))}
                        </div>
